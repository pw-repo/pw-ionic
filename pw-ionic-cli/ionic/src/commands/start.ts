...
import { validators } from 'pw-ionic-cli-framework/lib';
...
import { fsMkdir, fsUnlink, pathExists, removeDirectory } from 'pw-ionic-cli-framework/utils/fs';
...
export class StartCommand extends Command implements CommandPreRun {
  ...
  async validateName(name: string) {
    const { isValidPackageName } = await import('pw-ionic-cli-framework/utils/npm');
