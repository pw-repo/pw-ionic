...
import { contains, validate } from 'pw-ionic-cli-framework/lib';
...
import { fsMkdirp, fsUnlink, pathExists } from 'pw-ionic-cli-framework/utils/fs';
...
export class SSHGenerateCommand extends SSHBaseCommand implements CommandPreRun {
  ...
  async run(inputs: CommandLineInputs, options: CommandLineOptions): Promise<void> {
    ...
    const shellOptions: any = { stdio: 'inherit', showCommand: false, showExecution: false, showError: false };
